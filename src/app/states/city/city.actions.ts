...
export const addCityFailure = createAction('[City] Add City Failure', props<{ error: string }>())
...
export const updateCityFailure = createAction('[City] Update City Failure', props<{ error: string }>())
...
export const deleteCityFailure = createAction('[City] Delete City Failure', props<{ error: string }>())
